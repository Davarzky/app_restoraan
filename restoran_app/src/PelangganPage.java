...
public class PelangganPage extends javax.swing.JInternalFrame {
   List<MPelanggan> pelangganList = new ArrayList<>();
    ...
    if (selectedRow != -1) {
        ...
        String noHp = (String) table.getValueAt(selectedRow, 3);
        String alamat = (String) table.getValueAt(selectedRow, 4);
 ...
 private void TampilkanData() {
    ...
    String query = "SELECT id_pelanggan, nama_pelanggan, jenis_kelamin, noHp, alamat FROM pelanggan";
    ...
    try (Connection konek = Koneksi.ConnectDB(); 
        ...
        while (rs.next()) {
            ...
            model.addRow(new Object[]{id, nama,jenisKelamin, noHp, alamat});
        }
    } catch (Exception e) {
        JOptionPane.showMessageDialog(this, "Error: " + e.getMessage());
        e.printStackTrace();
